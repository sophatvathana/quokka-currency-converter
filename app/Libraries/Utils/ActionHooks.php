...
// Instance of class
{
    ...
    public static function instance()
    {
        if (!self::$hooks_instance) {
            self::$hooks_instance = new ActionHooks();
        }
...
{
    return ActionHooks::instance()->add_action($name, $function, $priority);
}
/**
 * Run an action
 *
...
{
    return ActionHooks::instance()->do_action($name, $arguments);
}
/**
 * Remove an action
 *
...
{
    return ActionHooks::instance()->remove_action($name, $function, $priority);
}
/**
...
{
    return ActionHooks::instance()->action_exists($name);
}
